...
//            if (intrested.get(i).trim().equalsIgnoreCase(mediaTitle))
//                return false;
//        }
//        customers.get(d).getInterested().add(mediaTitle);
//        return true;
//    }
//
//
...
//                    if (customers.get(i).getInterested().contains(media.get(j).getTitle())) {
...
//                                customers.get(i).getInterested().remove(media.get(j).getTitle());
...
//        int m = -404;
//        for (int i = 0; i < media.size(); i++) {
//            if (media.get(i).getTitle().equalsIgnoreCase(mediaTitle))
//                m = i;
//        }
//        if (m != -404)
...
//            if (list.get(i).getTitle().equalsIgnoreCase(mediaTitle))
//                t = i;
//
//        }
//        if (t == -404) {
...
//
//
//        if (rating == null && artist == null && songs == null && title == null) {
//
//            for (int i = 0; i < media.size(); i++) {
...
//            return list;
//
//        } else if (rating != null || artist != null || songs != null || title != null) {
//            for (int i = 0; i < media.size(); i++) {
//
//                if (artist != null) {
